Feature: DB Pension with income and exclude income
  ...
  Scenario Outline: Verify the income and DB Pensions and Exclude the income
    ...
    Examples:
      ...
      | Fla_Test1 | Fla_Test1 | Automation | QA        | 01/01/1990 | England      | Male   | Automation Income DB Pension | Automated_income  | Salary     | Current Income      | 450000       | Automated_DBPension | Active       | Statement    | 31200         | 500000  | 12.7               | Relief At Source | Multiple       | 2                 |
