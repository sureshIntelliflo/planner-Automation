...
@scenario('../features/IncomeDBPensions_ExcludeIncome.feature', 'Verify the income and DB Pensions and Exclude the income')
def test_verify_the_income_and_db_pensions_and_exclude_the_income():
    """Verify the income and DB Pensions and Exclude the income."""
