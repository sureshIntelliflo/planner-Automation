# coding=utf-8
"""Income and DC Pension then Exclude income feature tests."""
import pytest
...
@scenario('../features/IncomeDCPension_excludeIncome.feature', 'Verify the DC Pension and Income linking and exclude income')
def test_verify_the_dc_pension_and_income_linking_and_exclude_income():
    """Verify the DC Pension and Income linking and exclude income."""
