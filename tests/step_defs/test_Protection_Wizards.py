# coding=utf-8
"""Wizards - Protection Wizard feature tests."""
import pytest
...
@scenario('../features/Protection_Wizard.feature', 'Verify the Protection Wizard functionality from Wizards')
def test_verify_the_protection_wizard_functionality_from_wizards():
    """Verify the Protection Wizard functionality from Wizards."""
...
def i_run_the_protection_wizards_with_default_options_financialgoal_goaltype_targetyear(browser, FinancialGoal, Goaltype, TargetYear, BenefitType, Term):
    """I run the Protection Wizards with default options <FinancialGoal> <Goaltype> <TargetYear>."""
    page_wizards = Wizards(browser)
    page_wizards.NavigatetoWizards()
    page_wizards.NavigatetoProtectionWizard()
    page_wizards.FinancialGoal(FinancialGoal, Goaltype, TargetYear)
    page_wizards.ProtectionWizard(BenefitType, Term)
...
def i_export_the__wizards_results(browser):
    ...
    page_wizards = Wizards(browser)
    page_wizards.VerifyProtectionWizard()
